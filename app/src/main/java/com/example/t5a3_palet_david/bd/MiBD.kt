...
import com.example.t5a3_palet_david.dao.ClienteDAO
import com.example.t5a3_palet_david.dao.CuentaDAO
import com.example.t5a3_palet_david.dao.MovimientoDAO
...
protected constructor(context: Context?) :
    ...
    private fun insercionDatos(db: SQLiteDatabase) {
        ...
        db.execSQL("INSERT INTO movimientos (rowid, id, tipo, fechaoperacion, descripcion, importe, idcuentaorigen, idcuentadestino) VALUES (null, null, 1, 1420326180000, 'Devolución Telefónica Diciembre 2015', 30.76, 1, 1);")
